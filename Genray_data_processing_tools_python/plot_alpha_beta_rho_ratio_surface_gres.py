#!/usr/bin/env python3
"""
从 genray_scan_results.jsonl 读取扫描结果，对每个 (α, β) 取 powden_e 峰值对应的 ρ，
...
DEFAULT_JSONL = SCRIPT_DIR / "genray_scan_results.jsonl"
...
def plot_one_case(
    ...
    if np.any(np.isfinite(Z)):
        try:
            ...
            ax.clabel(cs, inline=True, fontsize=16, fmt="%.2f")
        except ValueError:
            pass
